...
def test_empty_md5file():
    empty_handle = tempfile.TemporaryFile('rb')
...
def test_license_md5file():
    license_handle = tempfile.NamedTemporaryFile(mode = 'wb', buffering = 0, delete = False)
    try:
        license_handle.write(__doc__.encode('utf8'))
